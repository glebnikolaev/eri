<header> <!-- Fixed navbar -->
    <nav class="navbar navbar-expand-md navbar-dark bg-dark">
        <div class="container-fluid"><a class="navbar-brand" href="#">ЕРИ Парсер</a>
            ...
            <div class="collapse navbar-collapse" id="navbarCollapse">
                <ul class="navbar-nav me-auto mb-2 mb-md-0">
                    ...
                    <li class="nav-item"><a class="nav-link" href="/houses">Дома</a></li>
                    <li class="nav-item"><a class="nav-link" href="/plates">Участки</a></li>
                </ul>
